...
class Skill
{
    ...
    const SKILL_ARCHAEOLOGY = 28;
    const SKILL_NECROMANCY = 29;
    ...
    public static function initializeSkills(): void
    {
        ...
        self::$skills = [
            ...
            self::SKILL_HERBLORE => new Skill(self::SKILL_HERBLORE, "Herblore", true),
            ...
            self::SKILL_FARMING => new Skill(self::SKILL_FARMING, "Farming", true),
            ...
            self::SKILL_ARCHAEOLOGY => new Skill(self::SKILL_ARCHAEOLOGY, "Archaeology", true),
            self::SKILL_NECROMANCY => new Skill(self::SKILL_NECROMANCY, "Necromancy", true),
        ];
    }
    ...
    public function getLevel(int $xp): int
    {
        ...
        $cap = $this->isHighLevelCap() ? 120 : 99;
